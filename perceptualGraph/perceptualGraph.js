var data = [
    {
        name: "HSL Rainbow",
        labelOffset: 60,
        value: function (t) { return d3.hsl(t, 1, 0.5); }
    },
    {
        name: "HCL Rainbow",
        labelOffset: 20,
        value: function (t) { return d3.hsl(t, 1, 0.15); }
    },
    {
...
svg.append('rect')
    ...
    .on('mousemove', function (d, i) {
        ...
        var tempRect = bar.append('rect')
            .attr('x', function(d, i) {
                let newX;
                if (prevX < x) newX = x - tempRectWidth; // if we are moving right
...
var highlightRect = bar.append('rect')
    .attr('x', -10)
    .attr('y', 0)
    .attr('width', 2)
    .attr('height', height)
...
var highlightRectText = bar.append('text')
    .attr('x', 0)
    .attr('dy', -5)
    .style('fill', function(d, i) {})
    .text(function(d) { console.log(d); return 'AB'; });
// end highlightRect
